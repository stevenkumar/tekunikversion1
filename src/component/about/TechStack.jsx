    ...
    return (
        <div>
            <div className="text-center max-w-3xl mx-auto py-12">
                <p className="text-blue-600 font-semibold tracking-wide uppercase text-sm mb-3">
                    Technologies
                </p>
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:flex lg:flex-wrap lg:justify-center lg:gap-6">
                {tech.map((item, index) => (
                    <div
                        ...
                        hover:shadow-lg hover:-translate-y-1 hover:border-blue-600 hover:text-blue-600 transition-all duration-300 cursor-pointer group"
                    >
