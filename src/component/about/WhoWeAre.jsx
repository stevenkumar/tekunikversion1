    ...
    <section className="py-16 bg-gray-50 overflow-hidden rounded-2xl">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-block mb-4 px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-semibold tracking-wide uppercase">
              About Our Agency
            </div>
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
              We Build{' '}
              <span className="bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-purple-600 to-pink-500 animate-gradient-x">
                Modern Web
              </span>{' '}
              <br />
              & App Solutions.
            ...
            <div className="space-y-4 mt-8">
              {[
                ...
                >
                  <span className="flex-none w-6 h-6 rounded-full bg-linear-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white text-xs shadow-md group-hover:scale-110 transition-transform duration-300">
                    ✓
                  </span>
