            ...
            <ul className="space-y-3">
              {resourcesLinks.map((link) => (
                <li key={link.label}>
                  ...
                  >
                    <span className="transition-all duration-300 group-hover:text-indigo-400 group-hover:translate-x-1">
                      {link.label}
                    </span>
            ...
            <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="w-full rounded-lg bg-slate-800 px-4 py-2 text-sm text-white
                           ...
                           hover:bg-slate-700 hover:ring-indigo-500/50
            ...
            {legalLinks.map((link) => (
              <a
                ...
                className="text-sm text-slate-400 transition-colors duration-300 ease-out
                           hover:text-indigo-400 hover:underline hover:underline-offset-2"
              >
                {link.label}
              </a>
            ))}
