...
export default function Navbar() {
  ...
  const getLinkClass = (path) => {
    return location.pathname === path
      ? "text-blue-600 font-semibold" // Agar active hai to Blue
      : "text-black hover:text-blue-600"; // Nahi to Gray + Hover Blue
  };
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className={`cursor-pointer flex items-center gap-1 hover:text-blue-600 ${
                  // Agar dropdown ke andar ka koi page open hai, to "Request Quote" bhi blue dikhega
