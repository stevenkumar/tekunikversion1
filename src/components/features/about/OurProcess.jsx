    ...
    <div className="min-h-screen bg-slate-50 py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Our Process: From Vision to <span className="text-blue-600">Reality</span>
          </motion.h2>
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-blue-100" />
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="w-full md:w-5/12">
                <div className="p-6 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow border border-slate-100">
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg border-l-4 border-blue-500">
                    <p className="text-xs italic text-blue-700 font-medium">
              ...
              {/* Center Dot */}
              <div className="z-10 flex items-center justify-center w-10 h-10 bg-blue-600 rounded-full text-white font-bold shadow-lg my-6 md:my-0">
                {index + 1}
              </div>
