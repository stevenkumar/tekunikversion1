    ...
    <div className="min-h-screen bg-[#050505] text-white py-20 px-6 font-sans">
      <div className="max-w-6xl mx-auto">
        <header className="mb-16">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-blue-500 font-mono mb-2 tracking-widest uppercase text-sm">Expertise List</motion.p>
          ...
          {selectedId && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-10">
              ...
              >
                ...
                <div className={`w-full md:w-1/3 bg-gradient-to-br ${selectedService.gradient} p-12 flex flex-col justify-between`}>
                ...
                <div className="w-full md:w-2/3 p-8 md:p-16 relative">
                  ...
                  <div className="space-y-8">
                    <section>
                      <h5 className="text-blue-500 font-bold uppercase text-xs tracking-widest mb-4">The Solution</h5>
                    ...
                    <section className="p-6 bg-white/5 rounded-2xl border-l-4 border-blue-500">
