...
const HeroSection = () => {
  return (
    <div className="min-h-screen bg-[#d0e1e9] font-sans text-slate-800">
      {/* Navigation Bar */}
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="bg-[#1a2b3c] text-white px-5 py-2 rounded-full text-sm">
            Book Now
          </button>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-8 pt-12 pb-24 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6">
            <h1 className="text-5xl md:text-6xl font-serif leading-tight text-[#1a2b3c]">
              Acts office dits book <br /> 
              <span className="italic">Ilove Tis lijch</span>
            </h1>
            ...
            <button className="bg-[#1a2b3c] text-white px-8 py-3 rounded-full hover:bg-opacity-90 transition-all">
              Discover More
            </button>
          </div>
        </div>
        ...
        <div className="mt-12 flex flex-wrap justify-center lg:justify-end items-end gap-6 md:gap-12">
          ...
          {/* Sphere/Ball Decor */}
          <div className="w-32 h-32 bg-[#a8c3cf] rounded-full shadow-inner flex items-center justify-center">
             <div className="w-24 h-24 bg-[#b8d4e0] rounded-full blur-sm opacity-50"></div>
          </div>
