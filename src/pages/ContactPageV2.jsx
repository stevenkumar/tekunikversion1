                ...
                <div className="md:w-3/5 p-6 md:p-10 bg-white">
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        ...
                        <button
                            ...
                            className={`bg-[#00A99D] text-white px-8 py-3 rounded-md font-medium text-sm transition shadow-md ${status.loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#008c82]'}`}
                        >
