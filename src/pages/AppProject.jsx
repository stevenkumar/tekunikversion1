...
export default function AppProject() {
  ...
  // 3. Styling Classes
  const inputClass = "w-full mt-1 border border-slate-300 rounded-xl p-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all";
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
        ...
        <div className="bg-blue-600 p-8 text-white">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="bg-blue-800 px-3 py-1 rounded-full text-xs font-bold">Step {step} of 5</span>
          </div>
          <p className="text-blue-100 my-3 text-sm uppercase font-bold tracking-widest">
            Step {step} of 5 — {Math.round((step / 5) * 100)}% Completed
          </p>
          <div className="w-full bg-blue-900/30 h-2 rounded-full">
            <div 
        ...
        <form onSubmit={(e) => e.preventDefault()} className="p-8 md:p-12">
          ...
          {step === 2 && (
            <div className={sectionClass}>
              ...
              <div className="space-y-4">
                ...
                {form.hosting === "Yes" && (
                  <div className="p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-xl animate-in slide-in-from-left-2">
          ...
          {step === 5 && (
            <div className={sectionClass}>
              ...
              <div className="mt-8 bg-blue-600 rounded-2xl p-6 text-white shadow-lg">
                <button 
                  type="button" 
                ...
                {showAdvice && (
                  <div className="mt-4 space-y-3 pt-4 border-t border-blue-400 animate-in slide-in-from-top-2">
                    {getAdvice().length > 0 ? (
                      getAdvice().map((item, i) => <p key={i} className="text-sm font-medium bg-blue-700/50 p-3 rounded-lg">{item}</p>)
                    ) : (
            ...
            <div className="ml-auto">
              {step < 5 ? (
                <button 
                  type="button" 
                  onClick={nextStep} 
                  className="bg-blue-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-blue-700 shadow-lg transition active:scale-95"
                >
                  Next Step
                </button>
              ) : (
                <button 
                  ...
                  className="bg-green-600 text-white px-10 py-3 rounded-xl font-bold hover:bg-green-700 shadow-lg transition active:scale-95"
                >
                  Submit Project
                </button>
              )}
