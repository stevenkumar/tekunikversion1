...
export default function MobileAppProject() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-25 px-4 font-sans">
        ...
        <form onSubmit={async (e) => {
            ...
            >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-2">
                      {["UI Design", "UX Research", "App Development", "App Store Launch", "Training"].map((item) => (
                        <label key={item} className={`flex items-center p-3 border rounded-xl hover:bg-slate-50 cursor-pointer transition ${form.parts.includes(item) ? 'border-brand-green bg-brand-green/5' : ''}`}>
              ...
              {step === 5 && (
                <>
                  ...
                  <div className="mt-6">
                    <label className={labelClass}>Additional Thoughts</label>
              ...
              {step === 6 && (
                <>
                  <h2 className="text-xl font-bold text-slate-800 border-b pb-2 mb-4">Final Review: Mobile Project</h2>
                  <div className="space-y-6">
                    <ReviewSummaryCard
                      ...
                      items={[
                        ...
                        { label: "Launch Date", value: form.deadline, key: "deadline", type: "date" },
                      ]}
                    />

                    <ReviewSummaryCard
                      title="Step 2: App Core"
                      onUpdate={handleUpdate}
                      onRemoveTag={removeTag}
                      items={[
                        { label: "Summary", value: form.summary, key: "summary", type: "textarea" },
                        { label: "Platforms", value: form.platforms, key: "platforms", type: "select", options: ["iOS", "Android", "Both"] },
                        { label: "Scope", value: form.parts, key: "parts", type: "tags" },
                      ]}
                    />

                    <ReviewSummaryCard
                      title="Step 3: Business Strategy"
                      onUpdate={handleUpdate}
                      onRemoveTag={removeTag}
                      items={[
                        { label: "Target Users", value: form.targetUsers, key: "targetUsers" },
                        { label: "Phase", value: form.phases, key: "phases", type: "select", options: ["MVP (Minimum Viable Product)", "Full Version", "Redesign"] },
                        { label: "Pricing Model", value: form.freePaid, key: "freePaid", type: "select", options: ["Free App", "Paid App", "Subscription Based"] },
                      ]}
                    />

                    <ReviewSummaryCard
                      title="Step 4: Technical Specs"
                      onUpdate={handleUpdate}
                      onRemoveTag={removeTag}
                      items={[
                        { label: "Need Backend", value: form.backend, key: "backend", type: "select", options: ["Yes", "No"] },
                        { label: "Backend Tech", value: form.tech, key: "tech" },
                        { label: "Need Payment", value: form.payment, key: "payment", type: "select", options: ["Yes", "No"] },
                        { label: "Gateways", value: form.thirdParty, key: "thirdParty", type: "tags" },
                      ]}
                    />

                    <ReviewSummaryCard
                      title="Step 5: Launch & Maintenance"
                      onUpdate={handleUpdate}
                      onRemoveTag={removeTag}
                      items={[
                        { label: "App Store Launch", value: form.appStoreLaunch, key: "appStoreLaunch", type: "select", options: ["Yes", "No"] },
                        { label: "Maintenance", value: form.maintenance, key: "maintenance", type: "select", options: ["Yes", "No"] },
                        { label: "Extra Info", value: form.extra, key: "extra", type: "textarea" },
                      ]}
                    />
                      ...
                      <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between pt-6 border-t border-slate-200">
                          ...
                          <div className="flex items-center gap-3 w-full sm:w-auto">
                            ...
                            >
                              {status.loading ? 'Submitting...' : 'Final Submit App Project'}
                            </button>
                          </div>
                        </div>
                      </div>
          ...
          {status.success && (
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="mt-4 p-4 bg-green-50 border border-green-200 text-green-700 rounded-xl text-sm font-semibold">
              🎉 Your mobile app project has been submitted successfully! We'll get back to you soon.
            </motion.div>
          )}
